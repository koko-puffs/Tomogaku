    ...
    <div v-else-if="userProfile" class="user-profile">
      <div class="profile-header">
        <div class="flex items-center gap-4">
          <img v-if="isCurrentUser && authStore.user?.user_metadata?.avatar_url"
            :src="authStore.user.user_metadata.avatar_url" class="w-20 h-20 rounded-full" alt="Profile avatar" />
          <div>
      ...
      <button v-if="canFollow" @click="handleFollowToggle" :disabled="followLoading" class="button-visible"
