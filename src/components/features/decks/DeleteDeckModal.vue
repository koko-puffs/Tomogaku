<template>
    <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div class="relative w-[400px] bg-neutral-900 rounded-lg shadow-xl border border-neutral-800 motion-translate-y-in-[3%] motion-opacity-in-[0%] motion-duration-[0.2s]">
        <!-- Header -->
        ...
        <div class="flex justify-end gap-2 px-5 py-3 border-t border-neutral-800">
          ...
          <button 
            @click="handleDelete" 
            class="w-24 button-cancel-visible"
            :disabled="loading"
          >
