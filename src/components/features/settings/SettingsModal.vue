<template>
  <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
    <!-- Modal container -->
    <div
      class="relative w-[1000px] h-[1000px] bg-neutral-900 rounded-lg shadow-xl border border-neutral-800 motion-translate-y-in-[3%] motion-opacity-in-[0%] motion-duration-[0.2s]">
      <!-- Header -->
