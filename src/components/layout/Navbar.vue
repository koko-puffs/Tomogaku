      ...
      <div class="flex items-center justify-end flex-1 space-x-2">
        ...
        <div v-else class="relative" ref="dropdownRef">
          ...
          <div v-if="isDropdownOpen"
            class="absolute right-0 w-48 py-2 mt-1 border rounded-lg shadow-xl bg-neutral-900 border-neutral-800 motion-translate-x-in-[0%] motion-translate-y-in-[-5%] motion-opacity-in-[0%] motion-duration-[0.2s] motion-duration-[0.15s]/opacity">
